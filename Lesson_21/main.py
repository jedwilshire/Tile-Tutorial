...
class Application:
    def __init__(self):
        ...
        pygame.display.set_caption('Tile Game Tutorial - Lesson 21 Adding Sounds, Splat, and Zombie Radius')
    ...
    def load_images(self):
        ...
        self.bullet_image = pygame.transform.scale(self.bullet_image, (BULLET_SIZE, BULLET_SIZE))
    ...
    def load_sounds(self):
        ...
        # load weapon sounds
        self.weapon_sounds = {}
        for sound in WEAPON_SOUNDS.keys():
            snd_file = os.path.join(self.sounds_folder, WEAPON_SOUNDS[sound])
            self.weapon_sounds[sound]= pygame.mixer.Sound(snd_file)
    ...
    def game_draw(self):
        ...
        pygame.display.set_caption("Tile Game Tutorial - Lesson 21 Adding Sounds, Splat, and Zombie Radius - FPS = {:.2f}".format(self.clock.get_fps()))
