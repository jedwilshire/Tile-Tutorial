...
class Application:
    def __init__(self):
        ...
        pygame.display.set_caption('Tile Game Tutorial - Improving World Graphics')
    ...
    def game_draw(self):
        ...
        pygame.display.set_caption("'Tile Game Tutorial - Improving World Graphics // FPS = {:.2f}".format(self.clock.get_fps()))
