...
class Camera:
    ...
    # change the target to centerx and centery
    def update(self, target):
        x = -target.rect.centerx + int(settings.SCREEN_WIDTH / 2) # change to centerx
        y = -target.rect.centery + int(settings.SCREEN_HEIGHT / 2) # change to centery
