...
class Player(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        if current_time - self.last_fire_time > WEAPONS[self.weapon]['rate']:
            ...
            for i in range(WEAPONS[self.weapon]['bullet_count']):
                ...
                self.vel += pygame.math.Vector2(-WEAPONS[self.weapon]['kickback'], 0).rotate(self.angle)
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, game, pos, angle):
        ...
        self.vel = pygame.math.Vector2(WEAPONS[self.game.player.weapon]['bullet_speed'], 0).rotate(self.angle)
