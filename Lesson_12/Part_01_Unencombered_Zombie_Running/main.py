...
class Application:
    def __init__(self):
        ...
        pygame.display.set_caption('Tile Game Tutorial - Lesson 12 Moving Zombies')
    ...
    def game_draw(self):
        ...
        pygame.display.set_caption("'Tile Game Tutorial - Lesson 12 Moving Zombies// FPS = {:.2f}".format(self.clock.get_fps()))
