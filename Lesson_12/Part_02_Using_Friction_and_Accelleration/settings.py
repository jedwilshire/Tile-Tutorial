...
### IMAGE FILE NAMES
WALL_IMG_FILE = 'tile_11.png'
ZOMBIE_IMG_FILE = 'zombie1_hold.png'
PLAYER_IMG_FILE = 'manBlue_gun.png' # located in /images
...
### ZOMBIE SETTINGS
ZOMBIE_ACCELERATION = 150 # pixels per second per second
